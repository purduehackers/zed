...
// Zed Codespaces (vendor/README.md): only the shared-memory browser parker has a thread that
// must never wait.
#[cfg(all(feature = "nightly", target_family = "wasm", target_feature = "atomics"))]
pub use self::imp::mark_current_thread_cannot_wait;
...
pub use self::imp::main_thread_park_count;
