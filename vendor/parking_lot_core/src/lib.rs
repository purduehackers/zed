...
// Zed Codespaces (vendor/README.md): the browser's main thread marks itself so its parks spin.
#[cfg(all(feature = "nightly", target_family = "wasm", target_feature = "atomics"))]
pub use self::thread_parker::mark_current_thread_cannot_wait;

#[cfg(all(
    feature = "wasm-test-hooks",
    feature = "nightly",
    target_family = "wasm",
    target_feature = "atomics"
))]
pub use self::thread_parker::main_thread_park_count;
